...
$(STEM)_INCLUDES := $($(STEM)_INCLUDES) $(foreach dep,$($(STEM)_DEPENDSON),$($(dep)_XINCLUDES))
...
$(STEM)_XINCLUDES := $(Dir) $($(STEM)_XINCLUDES) $(foreach dep,$($(STEM)_DEPENDSON),$($(dep)_XINCLUDES))
